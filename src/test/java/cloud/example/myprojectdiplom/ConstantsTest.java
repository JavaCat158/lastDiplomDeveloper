package cloud.example.myprojectdiplom;
...
public class ConstantsTest {
    ...
    public static final FileDataApply EDIT_FILE_NAME_RQ = new FileDataApply(NEW_FILENAME);

    public static final MultipartFile MULTIPART_FILE = new MockMultipartFile(FILENAME_2, FILE_CONTENT_2);

    public static final FileJsonName FILE_RS_1 = new FileJsonName(FILENAME_1, SIZE_1);
    public static final FileJsonName FILE_RS_2 = new FileJsonName(FILENAME_2, SIZE_2);
    public static final List<FileJsonName> FILE_RS_LIST = List.of(FILE_RS_1, FILE_RS_2);
